...
int main(void)
{
    ...
    font = LoadFont(TextFormat("%sresources/mecha.png", currentPath.c_str()));
    // music = LoadMusicStream(TextFormat("%sresources/ambient.ogg", currentPath.c_str())); // TODO: Load music
    fxCoin = LoadSound(TextFormat("%sresources/coin.wav", currentPath.c_str()));
